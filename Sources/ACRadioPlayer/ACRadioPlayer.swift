...
// MARK: - ACRadioPlayingState

/**
 `ACRadioPlayingState` is the Player playing state enum
 */

@objc public enum ACRadioPlaybackState: Int {
...
// MARK: - ACRadioPlayerState

/**
 `ACRadioPlayerState` is the Player status enum
 */

@objc public enum ACRadioPlayerState: Int {
...
/**
 The `ACRadioPlayerDelegate` protocol defines methods you can implement to respond to playback events associated with an `ACRadioPlayer` object.
 */

@objc public protocol ACRadioPlayerDelegate: AnyObject {
    /**
     Called when player changes state
     
     - parameter player: ACRadioPlayer
     - parameter state: ACRadioPlayerState
     */
    ...
    /**
     ...
     - parameter player: ACRadioPlayer
     - parameter state: ACRadioPlaybackState
     */
     ...
     */
    @objc optional func radioPlayer(_ player: ACRadioPlayer, itemDidChange url: URL?)
     ...
     */
    @objc optional func radioPlayer(_ player: ACRadioPlayer, metadataDidChange artistName: String?, trackName: String?)
     ...
     */
    @objc optional func radioPlayer(_ player: ACRadioPlayer, metadataDidChange rawValue: String?)
     ...
     */
    @objc optional func radioPlayer(_ player: ACRadioPlayer, artworkDidChange artworkURL: URL?)
}
...
open class ACRadioPlayer: NSObject {
    
    // MARK: - Properties
    
    /// Returns the singleton `ACRadioPlayer` instance.
    public static let shared = ACRadioPlayer()

    /**
     The delegate object for the `ACRadioPlayer`.
     Implement the methods declared by the `ACRadioPlayerDelegate` object to respond to user interactions and the player output.
     */
    open weak var delegate: ACRadioPlayerDelegate?
    ...
    /// HTTP headers for AVURLAsset (Ex: `["user-agent": "ACRadioPlayer"]`).
    ...
    /// Player current state of type `ACRadioPlayerState`
    open private(set) var state = ACRadioPlayerState.urlNotSet {
        didSet {
    ...
    /// Playing state of type `ACRadioPlaybackState`
    open private(set) var playbackState = ACRadioPlaybackState.stopped {
        didSet {
    ...
    private func shouldGetArtwork(for rawValue: String?, _ enabled: Bool) {
        ...
        ACRadioAPI.getArtwork(for: rawValue as String, size: artworkSize, completionHandler: { [unowned self] artworlURL in
            DispatchQueue.main.async {
...
extension ACRadioPlayer: AVPlayerItemMetadataOutputPushDelegate {
